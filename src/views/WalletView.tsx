          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm space-y-2 text-xs text-slate-600">
              ...
              <div className="space-y-1.5 text-[11px]">
                <div>Γ£ô Instant zero-fee checkout across all 6 travel categories</div>
                <div>Γ£ô Instant 100% automated refund on eligible cancellations</div>
                <div>Γ£ô Direct 1-tap peer settlements in group trips</div>
              </div>
            </div>
          </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-slate-400 font-mono">
                            {new Date(tx.timestamp).toLocaleString()} ΓÇó Ref: #{tx.id}
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="space-y-2 text-xs">
                    {settlements.length === 0 ? (
                      <div className="p-3 bg-white/10 rounded-xl text-center text-emerald-300 font-semibold">
                        Γ£ô All group balances are fully settled!
                      </div>
                    ) : (
                        ...
                        return (
                          <div key={idx} className="p-3 bg-white/10 backdrop-blur-md rounded-xl border border-white/10 space-y-2">
                            ...
                            <div className="text-[11px] text-slate-300 flex items-center justify-between">
                              <span>owes Γ₧ö {s.toMemberName}</span>
                              <button
                        ...
                        >
                          <div className="space-y-1">
                            ...
                            <div className="text-slate-500 text-[11px]">
                              Paid by <span className="font-bold text-slate-700">{exp.paidByName}</span> ΓÇó {exp.date}
                            </div>
                          </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl font-medium focus:outline-none"
                  >
                    <option value="Food">≡ƒì╜∩╕Å Food & Dining</option>
                    <option value="Stay">≡ƒÅ¿ Stay & Hotel</option>
                    <option value="Transport">≡ƒÜù Transport / Rides</option>
                    <option value="Activities">≡ƒÄƒ∩╕Å Activities & POIs</option>
                    <option value="Shopping">≡ƒ¢ì∩╕Å Shopping</option>
